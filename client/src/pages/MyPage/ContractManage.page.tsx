...
export const ContractManage = () => {
    ...
    return(
        ...
        <Stack direction="column" sx={{paddingX:'20px', width:'100%'}}>
            <Typography sx={{color:'#511523', fontSize:'25px', paddingX:'15px', marginTop:'25px', fontWeight:fontBold }}>
                制作中の案件一覧
            </Typography>
            ...
            <Typography sx={{color:'#511523', fontSize:'25px', marginTop:'85px', paddingX:'15px', fontWeight:fontBold }}>      
                今依頼中の案件一覧      
            </Typography> 
