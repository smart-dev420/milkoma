    ...
    return(
        <>
            ...
            <div className="px-[2vw]">
                <p className="text-[30px] text-[#001219] mt-[20px]" style={{letterSpacing:'-4px', fontWeight:fontBold}}>クリエイター指名</p>
                <p className="text-[19px] text-[#511523]" style={{letterSpacing:'-1px', fontWeight:fontBold}}>インフルエンサーを指名して依頼する</p>
                {selectTab < 2?(    
...
const Step3 : React.FC<{}> = () => {
    ...
    return(
        ...
        <p className="text-[20px] text-[#554744] ml-[75px]">入力内容を確認の上、「完了」ボタンをクリックしてください。</p>
    ...
    return(
        ...
        <div className="flex flex-row mt-[75px]" style={{marginLeft:match_1024?'40px':''}}>
            <div className="flex flex-col" style={{fontWeight: '400', zIndex:'1'}}>
                ...
                <p className="text-[20px] text-[#B9324D] mb-[26px] mt-[30px]">②.ご不明点がある場合は<span className="underline" style={{fontWeight:fontBold}}>メッセージ</span>にてご質問いたします</p>
